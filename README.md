...
For details on the analysis and the findings, please refer to the [report](./Resources/Report.pdf) and [video presentation](https://youtu.be/OhegLseO53o).
...
Margin | Lesion mass margin, includes circumscribed, micro-lobulated, obscured, ill-defined and spiculated | Nominal | 48
